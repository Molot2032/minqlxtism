...
EVENT_DISPATCHERS.add_dispatcher(LaunchItemDispatcher)
EVENT_DISPATCHERS.add_dispatcher(TouchOurFlagDispatcher)
EVENT_DISPATCHERS.add_dispatcher(TouchEnemyFlagDispatcher)